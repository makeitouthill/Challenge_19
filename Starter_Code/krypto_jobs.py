...
ether_balance = account_balance / (10**18)
st.sidebar.write(f"Account Balance: {ether_balance} ETH")
...
st.sidebar.write(f"Total Wage for {hours} hour(s) of work: {wage} ETH")
...
if st.sidebar.button("Send Transaction"):
    ...
    wage_wei = Web3.toWei(wage, 'ether')
